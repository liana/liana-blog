...
<div class="grid md:grid-cols-2 gap-8 items-center mb-12">
  ...
  <div class="md:order-1">
    ...
    <p class="text-sm text-gray-400 mt-2 text-center">Desperate Housewives - Channel Four Promo</p>
  </div>
</div>
...
<div class="mt-12 text-center">
  <p class="text-gray-200 text-lg">When I'm not at work, you'll find me paying it forward through mentoring and building up the tech community, especially for women in tech.</p>
</div>
